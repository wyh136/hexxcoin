...
Setup
-----
Unpack the files into a directory and run hexx.exe.

Hexxcoin is the original Hexxcoin client and it builds the backbone of the network.
However, it downloads and stores the entire history of Hexxcoin transactions;
