...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Hexxcoins");
    case mBTC: return QString("Milli-Hexxcoins (1 / 1,000)");
    case uBTC: return QString("Micro-Hexxcoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
